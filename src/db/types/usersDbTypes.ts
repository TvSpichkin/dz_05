...
export enum userDbFields {
    id = "id", // Идентификатор
    login = "userName", // Имя пользователя; максимальная длина: 10, минимальная длина: 3, шаблон: ^[a-zA-Z0-9_-]*$, должен быть уникальным
    email = "email", // Почта; шаблон: ^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$, должна быть уникальной
    createdAt = "createdAt" // Дата создания
}; // Возможные поля выходной модели пользователя в БД
